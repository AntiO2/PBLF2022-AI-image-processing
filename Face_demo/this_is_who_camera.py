...
def cv2ImgAddText(img, text, left, top, textColor=(255, 255, 0), textSize=20):
    ...
    # 字体的格式
    fontStyle = ImageFont.truetype("fonts/truetype/arphic/ukai.ttc", textSize, encoding="utf-8")
    # 绘制文本
    ...
    if ret == True:       #如果摄像头读取图像成功
        ...
        if len(dets) != 0:
            ...
            for k, d in enumerate(dets):
                ...
                img = cv2ImgAddText(img,candidate[num],dlib.rectangle.left(d),dlib.rectangle.top(d)-30,(255, 255, 0), textSize=20)
